      ...
      >
        <Card className="bg-white shadow-lg overflow-hidden border-t-4 border-blue-500">
          <CardHeader className="bg-stone-50 border-b border-stone-200">
            <CardTitle className="text-3xl font-bold text-stone-800">Task 1 Writing Practice</CardTitle>
          </CardHeader>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {chartTypes.map((topic) => (
                    <div key={topic.value} className="flex items-center space-x-2">
                      ...
                      <Label htmlFor={topic.value} className="text-stone-700">{topic.label}</Label>
                    </div>
                  ))}
                </div>
              </RadioGroup>
